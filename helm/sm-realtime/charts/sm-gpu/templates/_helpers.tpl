...
{{- default (include "sm-gpu.appVersion" .) (get ((hasKey .Values.inferenceSidecar.env "REGISTER_FEATURES") | ternary ((get .Values.inferenceSidecar.env "REGISTER_FEATURES") | fromJson) .Values.inferenceSidecar.registerFeatures) "version") }}
{{- end }}
